      ...
      <div className="mx-auto max-w-7xl px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900 flex items-center space-x-4">
            <Logo size={40} className={undefined} />{" "}
          ...
          <div className="text-gray-600 text-lg leading-8">
            <p className="my-6">
              ...
              that refreshes every 2s. The events are stored in a context. We
            ...
            <ul className="list-decimal list-inside mb-3">
              ...
              <li>
                Clicking on a cell makes it editable and allows editing its
                value.
              </li>
            ...
            <ul className="list-decimal list-inside mb-3">
              ...
              <li>
                Add some components in the UI that allow navigating in time.
              </li>
            ...
            <ul className="list-disc list-inside">
              <li>
                The `Container` file must not be edited. Consider that this is
                the only constraint.
              </li>
